...
export default function ChannelsPageClient() {
  ...
  if (clubs.length === 0) return (<div className="ch-page"><div className="ch-wrap"><aside className="ch-sidebar"><div className="ch-sb-head"><span className="ch-sb-title">Channels</span><Link href="/clubs" className="ch-sb-browse">Browse all</Link></div><div style={{ padding: "40px 20px", textAlign: "center", color: "rgba(255,255,255,0.4)", fontSize: 13, lineHeight: 1.6 }}>You haven&apos;t followed any clubs yet.<br /><Link href="/clubs" style={{ color: "#9EF01A", textDecoration: "underline", marginTop: 12, display: "inline-block" }}>Browse clubs &rarr;</Link></div></aside><main className="ch-main"><div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: 400, color: "rgba(255,255,255,0.4)", gap: 16, textAlign: "center", padding: 40 }}><div style={{ opacity: 0.3 }}><BoltIcon size={48} /></div><div style={{ fontSize: 16, fontWeight: 700 }}>No channels yet</div><div style={{ fontSize: 13 }}>Follow clubs to see their channels here.</div><Link href="/clubs" style={{ color: "#9EF01A", fontWeight: 600, fontSize: 13, marginTop: 8 }}>Browse clubs &rarr;</Link></div></main></div></div>);
  ...
  return (<div className="channels-page ch-page">
    ...
    <div className="ch-wrap">
      <aside className="ch-sidebar">
        <div className="ch-sb-head"><span className="ch-sb-title">Channels</span><Link href="/clubs" className="ch-sb-browse">Browse all</Link></div>
